...
const history = require('connect-history-api-fallback'); //Handling Deep Linking on the Server

const app = express();

app.use(history({index: '/index.html'}));               // Handling Deep Linking on the Server
